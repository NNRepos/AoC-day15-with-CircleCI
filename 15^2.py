...
def main(input, summary=False):
  #vars
  global attackVal,HPVal,cave,Xsize,Ysize,units
  attackVal=3
  HPVal=200
  #main
  binLow=0
  ...
  while binLow<binHigh:
    ...
    if not summary:
      ...
      str(len(units))+'/'+str(raceCount),race,"left,"
      print "the sum of their hp is",HPSum,", and the HP*rounds product is",ans
      print
  if not summary:
